...
var PropsTable = (0, _radium2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(PropsTable, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            name === 'func' ? 'func()' : this.renderValueSelection(key, data.get('type').toJS(), scope)
          ),
    ...
    value: function renderNameOfProp(name, kind) {
      ...
      if (['string', 'number', 'bool', 'enum'].indexOf(kind) === -1) return name;else return _react2.default.createElement(
        'a',
        {
          href: '#' + name + '-variant',
    ...
    value: function renderValueSelection(key, type) {
      ...
      switch (type.name) {
        ...
        case 'arrayOf':
          return _react2.default.createElement(_JsonEditor2.default, _extends({ key: name, name: name }, defaultProps));
        case 'bool':
          return _react2.default.createElement(_Toggle2.default, _extends({ style: styles.toggle, trackStyle: toggleStyle.trackOff, trackSwitchedStyle: toggleStyle.trackSwitched, thumbSwitchedStyle: toggleStyle.thumbSwitched, thumbStyle: toggleStyle.thumbOff }, _extends({}, toggleProps, { checked: toggleProps.value, name: key })));
