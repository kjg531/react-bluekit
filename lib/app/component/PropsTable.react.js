    ...
    value: function renderValueSelection(key, type) {
      ...
      switch (type.name) {
        ...
        case 'arrayOf':
          return _react2.default.createElement(_JsonEditor2.default, _extends({ key: name, name: name }, defaultProps));
        case 'bool':
          return _react2.default.createElement(_Toggle2.default, _extends({ label: 'Simple', style: styles.toggle }, _extends({}, toggleProps, { checked: toggleProps.value, name: key })));
