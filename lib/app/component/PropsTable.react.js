    ...
    value: function renderValueSelection(key, type) {
      ...
      switch (type.name) {
        ...
        case 'arrayOf':
          return _react2.default.createElement(_JsonEditor2.default, _extends({ key: name, name: name }, defaultProps));
        case 'bool':
          return _react2.default.createElement(_Checkbox2.default, _extends({ key: name }, _extends({}, defaultProps, { checked: defaultProps.value, value: defaultProps.value, name: key })));
